        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-muted-foreground mb-6">
              Créer des expériences numériques exceptionnelles qui transforment les marques et stimulent la croissance
              des entreprises.
            </p>
            <div className="flex space-x-4">
              <Button variant="ghost" size="icon" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["À Propos", "Carrières", "Études de Cas", "Blog", "Contact", "Politique de Confidentialité"].map(
                (item, index) => (
                  <li key={index}>
                    <Button
                      variant="link"
